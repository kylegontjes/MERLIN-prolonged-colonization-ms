---
title: "Supplemental Table 1: Location of ESCrE genes on short-read assemblies"
author: "Kyle Gontjes"
date: "`r Sys.Date()`"
...
ESCrE_genotype_data$category <- ifelse(ESCrE_genotype_data$ampC_like ==T,"ampC-like",
                                       ifelse(ESCrE_genotype_data$ESBL == T,"ESBL",
                                              ifelse(ESCrE_genotype_data$carbapenemase == T,"Carbapenemase","Other")))
...
ESBL_prop_data$prop_plasmid <- paste0(ESBL_prop_data$prop_plasmid,"%")

colnames(ESBL_prop_data) <- c("ESCrE b-lactamase","Category","No. chromosome-inferred","No. plasmid-inferred","Percent plasmid-inferred")

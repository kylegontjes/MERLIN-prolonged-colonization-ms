...
get_clusters_under <- function(dataframe,pair_types,threshold){
  # Get pairs at or under threshold
...
get_cluster_membership <- function(isolate,clustering){
  ...
  # Create list of cluster dataframe using the graph data
...
## Descriptive statistics for the number of clusters at this threshold (can be run on many thresholds if you want to know the impact of varying SNP threshold values)
```{r}

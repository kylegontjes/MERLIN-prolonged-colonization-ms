---
title: "MERLIN_SNP_cluster_detection_30_threshold"
author: "Kyle Gontjes"
date: "`r Sys.Date()`"
...
cluster_30_SNPs <- get_clusters_under(df,overall_pair_types,threshold=30)
```


# Merge clustering with metadata
```{r}
cluster_data <- cbind.data.frame(genomic_id = cluster_30_SNPs$cluster %>% names,cluster = cluster_30_SNPs$cluster)  
...
```{r} 
saveRDS(ST_df,"./Analysis/Household_transmission/MERLIN-prolonged-colonization-ms/data/SNP_distance/MERLIN_30_SNP_clusters.RDS")
``` 

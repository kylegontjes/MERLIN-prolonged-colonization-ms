...
# Species with more than one isolate
```{r}
...
# Subset metadata to species of interest 
```{r}
...
```{r}
voi = c("household",'subject_id','ncbi_id',"visit","collect_date","Species","Species_ST","subject_category",'subject_category_simplified')

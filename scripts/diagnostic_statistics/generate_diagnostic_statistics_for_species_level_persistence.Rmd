---
title: "generate_diagnostic_statistics_for_species_level_persistence"
author: "Kyle Gontjes"
date: "`r Sys.Date()`"
...
get_marginal_stats <- function(feature,outcome){ 
  ...
  false_persistence_rate = round(100-ppv,2)
  overall_disagreement = round(100-accuracy,2)
  
  
  data <- as.data.frame(cbind(phenotype = colnames(outcome),phenotype_count,phenotype_freq,feature_count,feature_freq,tp,fp,fn,tn,sens,spec,ppv,npv,recall,precision,f1,accuracy,lr_pos,false_persistence_rate,overall_disagreement))
...
```{r}
saveRDS(comparison_of_any_ESCRE_to_WGS_outcomes,"./data/diagnostic_statistics/species_level_diagnostic_statistics.RDS")
write.csv(comparison_of_any_ESCRE_to_WGS_outcomes,"./data/diagnostic_statistics/species_level_diagnostic_statistics.csv")
```

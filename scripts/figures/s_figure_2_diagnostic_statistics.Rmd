---
title: "Supplemental Figure 2: Accuracy of species-level evaluation of prolonged colonization"
author: "Kyle Gontjes"
date: "`r Sys.Date()`"
...
s_figure_2 <- cowplot::plot_grid(A,B,C,labels = "AUTO",ncol=3)
s_figure_2
```

# Save figure
```{r}
ggsave(plot = s_figure_2,filename = './figures/s_figure_2_diagnostic_statistics_species_prolonged_colonization.png',dpi = 900, width = 6, height = 6, bg='white')
```

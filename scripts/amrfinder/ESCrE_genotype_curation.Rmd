---
title: "Curate ESCrE genotype information for downstream analyses"
author: "Kyle Gontjes"
date: "`r Sys.Date()`"
...
paste0("Number of final isolates that were ESCRE and QC passing: ", length(isolates))
...
# Create ESBL and EScrE genotype classifiers
```{r}
...
paste0("Overall data:")
blactam_info %>% select(-class) %>%  arrange(element_symbol) %>% favorite_kable()

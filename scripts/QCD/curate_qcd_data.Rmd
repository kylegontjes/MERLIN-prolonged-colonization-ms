---
title: "Data Cleaning Step 2 - Curate QCD data"
author: "Kyle Gontjes"
date: "`r Sys.Date()`"
...
# ESCrE WGS Call
```{r}
escre_list <- read_csv("../data/INTEGRATE_MERLIN_WGS_Species_calls_030925_LLC.csv") %>% subset(Enterobacterales ==T)%>% .$Species
escre_list

master_qc$WGS_escre <- ifelse(master_qc$Species %in% escre_list,T,F)
```

# Get sequencing run specimen belonged to
```{r}

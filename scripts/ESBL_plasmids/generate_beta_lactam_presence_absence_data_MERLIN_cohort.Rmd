---
title: "Generate Beta-lactam presence and location data for full cohort"
author: "Kyle Gontjes"
date: "`r Sys.Date()`"
...
paste0("Number of genes: ",nrow(ESCrE_prop_data))
paste0("Number of plasmidic genes: ",nrow(ESCrE_prop_data %>% subset(prop_plasmid >0)))

# Save
saveRDS(ESCrE_prop_data,"./data/ESBL_plasmids/MERLIN_cohort_ESCrE_proportion_plasmidic.RDS")

# Generate plasmid presence
...
# Save
saveRDS(plasmid_data,"./data/ESBL_plasmids/MERLIN_cohort_beta_lactam_location_data.RDS")
```

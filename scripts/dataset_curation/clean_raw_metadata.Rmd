...
```{r}
# Metadata
metadata$isolate_info <- ifelse(grepl("MER", metadata$household_number_recode)==T, paste0(metadata$isolate_id,"_i"), paste0(metadata$household_number_recode, "_",metadata$visit, "_",metadata$isolate_id_recode))
```

---
title: "Data Cleaning Step 1 - Curate raw MERLIN metadata"
author: "Kyle Gontjes"
...
# 168H: ensure participant ID is correct
### NEW CHANGE October 2025
## 168hi
metadata$location_or_participant <- ifelse(metadata$household_number=="168H" & metadata$visit ==1 & metadata$location_or_participant =='166hi',"168hi",metadata$location_or_participant)
## 168hm1
metadata$location_or_participant <- ifelse(metadata$household_number=="168H" & metadata$isolate_id =="Stool 2A C1" & metadata$location_or_participant =='166hf1',"168hm1",metadata$location_or_participant)
```

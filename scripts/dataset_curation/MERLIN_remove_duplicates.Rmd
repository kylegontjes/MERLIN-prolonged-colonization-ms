...
MERLIN_234_MERLIN_233 <- duplicates_qc[[duplicates[10]]]
...
metadata$genomic_id <- ifelse(metadata$genomic_id == duplicates[10],gsub("MERLIN_233","",metadata$genomic_id) ,metadata$genomic_id) 
```
...
metadata$genomic_id <- ifelse(metadata$genomic_id == duplicates[11],gsub("MERLIN_120","",metadata$genomic_id) ,metadata$genomic_id) 
```
...
metadata$genomic_id <- ifelse(metadata$genomic_id == duplicates[12],gsub("MERLIN_118","",metadata$genomic_id) ,metadata$genomic_id) 
```
...
metadata$genomic_id <- ifelse(metadata$genomic_id == duplicates[13],gsub("MERLIN_294","",metadata$genomic_id)  %>% gsub("MERLIN_RE_8","",.),metadata$genomic_id)  
``` 

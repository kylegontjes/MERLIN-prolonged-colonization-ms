---
title: "Data Cleaning Step 8 - Curate final metadataset of specimens from index subjects"
author: "Kyle Gontjes"
date: "`r Sys.Date()`"
...
paste0("Number of metadata entries: ", nrow(df))
```

# Restrict dataset to QC passing index isolates
```{r}  
# QC passing ESCrE genomes
df_qc_passing <-  df %>% subset(qc_pass=="TRUE" & WGS_escre==TRUE)
paste0("Number of ESCrE qc-passing isolates: ",nrow(df_qc_passing))
